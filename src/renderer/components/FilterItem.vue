    ...
    computed:{
        ...
        todoNum(){
            if(this.data.id >= 0 || this.data.id === -4){
                let list = this.todoList.filter(item=>item.filterId === this.data.id)
                return list.length
            }
            if(this.data.id === -3){
                let list = this.todoList.filter(item=>item.star === 1)
                return list.length
            }
            if(this.data.id === -2){
